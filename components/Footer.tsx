...
export default function Footer() {
  return <footer className="bg-[#16201D] text-white mt-24">
    <div className="container py-16 grid md:grid-cols-3 gap-12">
      <div><div className="font-black text-3xl tracking-[-.06em]">MOVIN.</div><p className="text-white/60 mt-4 max-w-sm">Packaging solutions designed to protect products, strengthen brands, and move businesses forward.</p></div>
    ...
    <div className="container py-6 border-t border-white/10 text-xs text-white/40">© 2026 MOVIN. All rights reserved.</div>
  </footer>;
}